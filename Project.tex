...
\begin{document}
    ...
    % Reset link color for the main document content
        \hypersetup{
        linkcolor={FireBrick},
        citecolor={FireBrick},
        urlcolor={FireBrick}
    ...
    \begin{figure}[htbp]
        \centering
        \Acrobatmenu{GoBack}{\includegraphics[width=14cm]{./figures/ERDbeta_av_2022.eps}}
    ...
    \begin{figure}[htbp]
        \centering
        \Acrobatmenu{GoBack}{\includegraphics[width=17.5cm]{./figures/ERDbeta_topography_2022.eps}}
    ...
    \begin{figure}[htbp]
        \centering
        \Acrobatmenu{GoBack}{\includegraphics[width=17.5cm]{./figures/SCP_topography_2022.eps}}
    ...
    \begin{appendices}
        ...
        \begin{figure}[htbp]
            \centering
            \Acrobatmenu{GoBack}{\includegraphics[trim=0.1cm 1cm 0cm 1cm, clip, width=12cm]{./figures/UCM4-003.png}}
        ...
        \begin{figure}[htbp]
            \centering
            \Acrobatmenu{GoBack}{\includegraphics[width=9cm]{./figures/paradigm.png}}
            \caption{Paradigm used in the motor imagery trials. Image by J. Pinyol.}
            \label{fig:paradigm}
        \end{figure}
        The experiment was programmed using PsychoPy. Each trial had an approximate duration of \SI{5}{\second} and followed this structure (see \Cref{fig:paradigm}): programmed is correct
        \begin{itemize}
