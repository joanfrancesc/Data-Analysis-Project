...
\begin{document}
    ...
    \begin{center} % Keep figure environments centered if desired
        \begin{minipage}[t]{0.8\textwidth} % Use minipage to group figure and caption
            \centering
            \begin{figure}[H] % Consider [htbp] if layout issues persist
                \centering
        ...
        \begin{minipage}[t]{\textwidth} % Use minipage to group figure and caption
            \centering
            \begin{figure}[H] % Consider [htbp] if layout issues persist
                \centering
                \Acrobatmenu{GoBack}{\includegraphics[width=16cm]{./figures/ERDbeta_topography_2022.eps}} % Ensure figure path is correct
    ...
    \begin{center} % Keep figure centered
        \begin{minipage}[t]{\textwidth} % Use minipage to group figure and caption
            \centering
            \begin{figure}[H] % Consider [htbp] if layout issues persist
                \centering
                \Acrobatmenu{GoBack}{\includegraphics[width=16cm]{./figures/SCP_topography_2022.eps}} % Ensure figure path is correct
                \caption{Slow cortical potential topographies for the movements in \href{https://doi.org/10.1371/journal.pone.0182578}{P. Ofner et al., 2017}. Maps show the grand-average amplitude in \si{\micro\volt} of a \SI{0.5}{\second} segment selected just before the movement onset. Image by S. Romero.}
                \label{fig:SCPtopo}
            \end{figure}
        \end{minipage}
    \end{center}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{Or something completely different} that you may come up with (perhaps devising an original approach). % Made slightly more formal
    ...
    \subsection{Phase 4: Final Model Assessment and Reporting} % Changed & to and
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{Analysis and Discussion:} Analyse your results, discuss the strengths and weaknesses of your approach, compare the performance of different features and models, and reflect on challenges encountered. % British spelling Analyse is correct
            \item \textbf{Final Report and Presentation:} Prepare a comprehensive report detailing your entire workflow, methodology, results, and conclusions. Deliver a group presentation summarising your project. % British spelling summarising is correct
        \end{itemize}
    ...
    \begin{itemize}
        ...
        \begin{figure}[H] % Consider [htbp] if layout issues persist
            \centering
            \Acrobatmenu{GoBack}{\includegraphics[width=8cm]{./figures/AnakinPadme.jpg}} % Ensure figure path is correct
    ...
    \subsubsection{Contents}
    Your presentation, similarly to the report, should be a clear, concise, and well-structured document summarising your project. It can have a similar structure to the report, but it is not compulsory to follow it. % British spelling summarising is correct
    ...
    \begin{itemize}
        ...
        \item The document should be \textbf{one PDF document}. No additional files will be accepted. The \textbf{maximum allowed size} for the file is $\SI{\mathbf{200}}{\mathbf{\mega\byte}}$. % Corrected 'addditional', British spelling allowed is correct
    ...
    \section{Collaboration and Expectations} % Changed & to and
    ...
    \newpage
    % Prevent page break just before appendices if possible
    \nopagebreak
    ...
    \begin{appendices}
        ...
        \begin{itemize}
            \item The channel labels in the \texttt{.mat} data files contain the raw output from the OpenBCI system.
            ...
            \item The validated channel labels for analysis are, from 1 to 15: F7, F3, Fz, F4, F8, T3, C3, Cz, C4 , T4, P7, P3, Pz, P4, and P8. % British spelling analysis is correct
            \item A 16th channel is present due to amplifier configuration and must be excluded from subsequent analysis. % Corrected grammar
        \end{itemize}
        ...
        \begin{figure}[htbp] % Use standard float specifiers like [htbp] unless [H] is essential and checked
            \centering
